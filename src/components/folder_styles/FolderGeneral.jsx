...
export default function FolderGeneral({ title, icon = null, children, onClose, onMinimize, hideScrollbar = false, minimized = false, minimizing = false, closing = false, defaultWidth = 700, defaultHeight = 420, centered = false, dataWindowId, contentClassName = "p-4", cursor = null, dropPath = null }) {
